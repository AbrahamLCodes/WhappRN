...
export default function Talk(){
    ...
    return(
        <ImageBackground source={{uri:'https://www.la-prensa.com.mx/gossip/qcndzj-chelino-sanchez.gif/ALTERNATES/LANDSCAPE_1140/chelino-s%C3%A1nchez.gif'}} style={{flex: 1, padding:10, position: 'relative'}}>
            <ListMessages style={ {maxHeight: 1000, minHeight: 370 }} data={data} renderItem={(item) => renderListItem(item)}/>
            <KeyboardAvoidingView behavior={Platform.OS === 'android' ? 'padding': null} style={{flexDirection: 'row'}}>
                <InputContainer>         
                    <ContainerForm >
                        <ButtonCamera >
                            <Icon  name="mood" size={30} color="grey" style={{alignSelf: 'center'}} ></Icon>
                        </ButtonCamera>
                        ...
                        <ButtonCamera >
                            <Icon  name="camera-alt" size={30} color="grey" style={{alignSelf: 'center'}} ></Icon>
                        </ButtonCamera>
                    </ContainerForm >
                    <ButtonContainer>
                        <ButtonBox onPress={()=>{Sendmessage({varMessage})}}>
                            <Icon  name="send" size={30} color="white" style={{alignSelf: "center", paddingTop:10}}></Icon>
                        </ButtonBox>
                    </ButtonContainer>                 
                </InputContainer>          
